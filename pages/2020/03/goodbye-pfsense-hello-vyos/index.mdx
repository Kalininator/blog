...
<img alt="A worthless meme" src={require('./meme.jpg')} />
...
You can find a lot more info on this topic at Kroy’s blog.
...
<img alt="Jira tasks" src={require('./jira-tasks.png')} />
...
<img alt="VMkernel adapters" src={require('./vmkernal-adapters.png')} />
...
<img alt="Uptime monitor 1" src={require('./uptime-monitor-1.png')} />
...
<img alt="Uptime monitor 2" src={require('./uptime-monitor-2.png')} />
