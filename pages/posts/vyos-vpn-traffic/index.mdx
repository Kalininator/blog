...
<img alt="A worthless meme" src={require('./cover.png')} />
...
This solution worked rather effectively, and I had been using this setup happily for quite a while. The original guide I used for this can be found on MonsterMuffin’s blog. The post is quite old now, but it is still a working solution, so I would recommend looking at that if you are using pfSense.
...
The certificates can be found through this page on their site.
...
As usual, my timing was questionable with this, as the day after I set this up as an OpenVPN connection, PIA announced beta testing for WireGuard connection. I’ll probably switch the setup to that when it is out of beta.
