...
If you haven't read my previous posts, I recently built a new home server with the goal of completely replacing my server rack. This server would completely replace my existing power-hungry vSAN cluster, as well as replacing my NAS. This is what the newly built setup looks like, for the most part, as well as the existing rack for comparison.

<div style={{ display: 'flex', height:"300px" }}>
<img alt="Rack" style={{ width: "50%" }} src={require('./rack.jpg')} />
<img alt="Tower" style={{ width: "50%" }} src={require('./tower.png')} />
</div>
...
<img alt="Migration" src={require('./migration.png')} />
...
<img alt="Mostly empty rack" src={require('./mostly-empty-rack.png')} />

To wipe the drives, I used PartedMagic. It's a really nice tool, that can boot from an ISO and load into RAM. It has a lot of tools for wiping drives and getting stats off them. The wiping took quite a while with my 4TB drives, and was probably the most time consuming part of this migration.

<img alt="Nwipe statistics" src={require('./nwipe.png')} />

After all was done, I had a huge pile of equipment in my room, all of which needed to be sold off somehow.

<img alt="All hardware sitting on floor" src={require('./stuff-to-sell.png')} />
...
<img alt="Odroid HC2" src={require('./odroid.png')} />
...
<div style={{ display: 'flex', height:"300px" }}>
<img alt="Rack" style={{ width: "33%" }} src={require('./rack.jpg')} />
<img alt="Empty cupboard" style={{ width: "66%" }} src={require('./cupboard-after.jpeg')} />
</div>
...
<img alt="New lab in cupboard" src={require('./new-lab.png')} />
