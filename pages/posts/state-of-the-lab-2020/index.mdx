...
<img alt="Startech rack" src={require('./startech-rack.jpg')} style={{height: "300px"}} />
...
<img alt="vCenter screenshot of DC-HOME" src={require('./dc-home.png')} />
...
<img alt="vCenter screenshot of DC-COLO" src={require('./dc-colo.png')} />
...
<img alt="vCenter overview" src={require('./vcenter-overview.png')} />
