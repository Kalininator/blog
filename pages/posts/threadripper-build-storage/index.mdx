...
<img alt="Perc H310" src={require('./hba.jpg')} />

My HBA of choice here is the Dell Perc H310. This RAID card can be flashed into HBA mode fairly easily, and a great guide can be found here. The H200 used to be the card of choice, but this one is newer and their prices have dropped to be about the same. Another good choice would be to get an LSI HBA, but I have found they are harder to find in the UK, and these Dell cards are built off of LSI controllers anyway. This HBA cost me around £30, which is a pretty fair price.
...
<img alt="ESXi PCI Device Availability" src={require('./pci-device-availability.png')} />
<img alt="VM Settings" src={require('./vm-settings.png')} />
...
<img alt="WD Elements drives in their box" src={require('./boxed-drives.jpeg')} />
...
<img alt="Shucked drives" src={require('./shucked-drives.jpeg')} />
...
<img alt="6 pin power connector" src={require('./power-connector.jpeg')} />
...
<img alt="Zpool status" src={require('./zpool-status.png')} />

You can also view your datasets with `zfs list`.

<img alt="ZFS List" src={require('./zfs-list.png')} />
